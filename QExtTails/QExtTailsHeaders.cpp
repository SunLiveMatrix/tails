...
enum {
  ...
  SCI_VCHOMEWRAPEXTEND = 2454, SCI_LINECOPY = 2455, SCI_SETWRAPVISUALFLAGS = 2460,
  SCI_GETWRAPVISUALFLAGS = 2461, SCI_SETWRAPVISUALFLAGSLOCATION = 2462, SCI_GETWRAPVISUALFLAGSLOCATION = 2463,
  SCI_SETWRAPSTARTINDENT = 2464, SCI_GETWRAPSTARTINDENT = 2465, SCI_STARTRECORD = 3001,
...
enum {
  ...
  SC_MARK_ARROWS = 24, SC_MARK_PIXMAP = 25, SC_MARK_CHARACTER = 10000
};
...
enum {
  ...
  INDIC_HIDDEN = 5, INDIC_BOX = 6, INDIC0_MASK = 0x20,
...
enum {
  ...
  SC_PERFORMED_REDO = 0x40, SC_LASTSTEPINUNDOREDO = 0x100, SC_MOD_CHANGEMARKER = 0x200,
  SC_MOD_BEFOREINSERT = 0x400, SC_MOD_BEFOREDELETE = 0x800, SC_MODEVENTMASKALL = 0xf77
};

enum { SCMOD_SHIFT = 1, SCMOD_CTRL = 2, SCMOD_ALT = 4 };
enum {
  ...
  SCLEX_VBSCRIPT = 28, SCLEX_ASP = 29, SCLEX_PHP = 30,
